      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="flex justify-between items-center">
          <div>
            ...
            <p className="text-neutral-500">Métricas e conversões do Nutri Proud</p>
          </div>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200">
            <h3 className="text-neutral-500 font-medium">Usuários Registrados</h3>
            <p className="text-4xl font-bold text-neutral-800 mt-2">{totalUsers}</p>
          </div>
          
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200">
            <h3 className="text-neutral-500 font-medium">Visitantes (Anônimos)</h3>
            <p className="text-4xl font-bold text-neutral-800 mt-2">{totalAnon}</p>
          </div>
          
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200">
            <h3 className="text-neutral-500 font-medium">Total de Registros</h3>
            <p className="text-4xl font-bold text-neutral-800 mt-2">{totalLogs}</p>
          </div>
        </div>

        <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-200">
          <h2 className="text-xl font-bold text-neutral-800 mb-4">Em breve: Gráficos de Conversão</h2>
